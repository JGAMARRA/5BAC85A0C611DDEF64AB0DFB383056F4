...
public class GeneticAlgorithm<T>
{
	...
	public GeneticAlgorithm(T[] arr,int populationSize, Random random, Func<Cotizacion> fitnessFunction,
		int elitism, float mutationRate = 0.01f)
	{
		...
		{
			Population.Add(new DNA<T>(arr, dnaSize, random, fitnessFunction, shouldInitGenes: true));
		}
	}
